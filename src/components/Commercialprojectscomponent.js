...
const BASE_URL =
  "https://w3mantra.com/kalsi_admin/public/api/properties-by-project?city_id=1&project_type=2";
...
export const fetchNewLaunchProjects = async (
  ...
  try {
    ...
    console.error("Error fetching Commercial projects data:", error);
  }
};

const Commercialprojectscomponent = () => {
...
export default Commercialprojectscomponent;
