...
const BASE_URL = `${BASE_URL}/properties-by-project?city_id=1&project_type=1`;
...
export const fetchNewLaunchProjects = async (
  ...
  console.log("Fetching Residential projects data");
  try {
    ...
    const response = await fetch(
      `https://w3mantra.com/kalsi_admin/public/api/newLaunch-projects?${queryParams.toString()}`
    );
    console.log("response", response);
    const data = await response.json();
    console.log("Residential projects data", data);
...
const ResidentialProjectscomponent = () => {
  ...
  const renderHeading = () => {
    if (searchQuery === "") {
      return (
        <h2 className="text-center kss-primary-bg kss-fs-40 mt-2 mb-2">
          RESIDENTIAL PROJECTS
        </h2>
      );
    } else if (!projectData) {
      // If projectData is undefined, return a loading message or handle this case accordingly
      return (
        <h2 className="text-center kss-primary-bg kss-fs-40 mt-2 mb-2">
          Loading...
        </h2>
    ...
    <div className="project-list-section">
      ...
      <div className="project-list-bg">
        <div className="container ">
          ...
          {renderHeading()}
          <a className="project-list-link" href="/property-detail">
            {renderProjectList}
          </a>
          {/* Render pagination */}
          <Pagination
...
export default ResidentialProjectscomponent;
