...
const CommercialPropertyListing = ({ projectType, title }) => {
                ...
                <img
                  src={
                    project.project_name === "Residential "
                      ...
                      : "/assets/images/Commercial.svg" // Default icon in case no match
                  }
        ...
        <div className="container">
          ...
          <div className="row mt-3">
            ...
            >
              ...
              <div className="col-md-2 filter-select-carpet">
                <select
                  value={selectedCarpetArea}
                  onChange={handleCarpetAreaChange}
                  className="form-control"
...
export default CommercialPropertyListing;
