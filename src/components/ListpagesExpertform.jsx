...
// const ListpagesExpertform = ({ addressTitle, propertyiddata }) => {
//   console.log("property-data", propertyiddata);
...
// export default ListpagesExpertform;
...
const ListpagesExpertform = ({ addressTitle, propertyiddata, onSubmit }) => {
  console.log("property-data", propertyiddata);
  const [formData, setFormData] = useState({
    property_id: propertyiddata,
    name: "",
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.success) {
      ...
      setShowSuccessPopup(true);
      if (onSubmit) {
        onSubmit(formData); // Call the parent onSubmit handler if provided
      }
    } else {
      // Handle errors during form submission
      console.error(
